...
@export var moveForwardAction : String = "front"
@export var moveBackwardAction : String = "back"
@export var moveLeftAction : String = "left"
@export var moveRightAction : String = "right"
@export var runAction : String = "cntr"
@export var crouchAction : String = "c"
@export var jumpAction : String = "space"
